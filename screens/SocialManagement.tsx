   ...
   return (
      <div className="min-h-screen bg-black pb-24 animate-fade-in">
         ...
         <div className="bg-gradient-to-b from-emerald-900/20 to-black pt-10 pb-10 px-6 relative overflow-hidden">
            ...
            <button onClick={() => navigate(-1)} className="text-theme-text mb-6 relative z-10"><ArrowLeft /></button>
         ...
         <div className="px-6 space-y-8">
            ...
            <div className="border-y border-white/5 py-6">
               ...
               <div className="flex justify-center gap-3">
                  <div className="bg-obsidian-800 px-4 py-3 rounded-xl border border-white/5 flex items-center gap-2 min-w-[130px] justify-center shadow-lg">
                     ...
                     <span className="font-bold text-theme-text tracking-wider text-sm">PROTBEM</span>
                  </div>
                  <div className="bg-obsidian-800 px-4 py-3 rounded-xl border border-white/5 flex items-center gap-2 min-w-[130px] justify-center shadow-lg">
                     <Shield size={18} className="text-green-500" />
                     <span className="font-bold text-theme-text tracking-wider text-sm">ELEVAMAIS</span>
                  </div>
               </div>
            </div>
            ...
            <div className="space-y-6">
               <h3 className="text-theme-text font-bold text-sm border-l-2 border-emerald-500 pl-3">O que entregamos</h3>
