        ...
        <div className="min-h-screen bg-black font-sans text-white pb-20">
            ...
            {step === 2 && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/95 backdrop-blur-sm p-6">
                    <div className="bg-zinc-900 border border-gold-500/30 p-8 rounded-2xl max-w-md w-full text-center animate-scale-up">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="relative">
                            <select
                                ...
                                onChange={handleChange}
                                className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 pl-11 text-sm text-white focus:border-gold-500 focus:ring-1 focus:ring-gold-500 outline-none transition-all appearance-none"
                            >
